...
router.get("/my-follows", auth, fxn.getUserFollows);

router.get("/my-membership", auth, fxn.getUserMembership);

router.post("/follow", auth, fxn.followStreamer);

router.post("/unfollow", auth, fxn.unfollowStreamer);

router.get("/streamer-profile/:streamerId", auth, fxn.getStreamerProfile);
