# MSC LIVE - Video Streaming Platform API

This is a Node.js/Express API project for MSC LIVE, a high-performance real-time video streaming platform designed to support **20,000+ concurrent users** with dual 1080p high-definition video streams.

## Project Overview

MSC LIVE is a scalable video streaming platform with the following user roles:
...
```bash
git clone https://git.devtechnosys.tech/mohit_nag/msc-api.git
cd msc-api
```
